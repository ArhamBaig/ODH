    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          whileInView={{ opacity: 1, width: "280px" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[280px] bg-gradient-conic from-cyan-300 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[280px] bg-gradient-conic from-transparent via-transparent to-cyan-300 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[280px] -translate-y-[7rem] bg-primary/40 "
        ></motion.div>
